...
public class MateState : State
{
    ...
    public MateState(CommonAnimal commonAnimal, StateMachine stateMachine) : base(commonAnimal, stateMachine)
    {
    }
    ...
    {
        base.Enter();
        commonAnimal.animations.PlayAnimation(commonAnimal.animations.MATE);
