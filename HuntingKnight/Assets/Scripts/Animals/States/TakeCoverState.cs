...
public class TakeCoverState : State
{
    ...
    public TakeCoverState(CommonAnimal commonAnimal, StateMachine stateMachine) : base(commonAnimal, stateMachine)
    {
    }
    ...
    {
        base.Enter();
        commonAnimal.animations.PlayAnimation(commonAnimal.animations.TAKE_COVER);
