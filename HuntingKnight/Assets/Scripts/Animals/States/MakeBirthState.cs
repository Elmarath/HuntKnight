...
public class MakeBirthState : State
{
    // Condition variables set here

    public MakeBirthState(CommonAnimal commonAnimal, StateMachine stateMachine) : base(commonAnimal, stateMachine)
    {
    }
    ...
    {
        base.Enter();
        commonAnimal.animations.PlayAnimation(commonAnimal.animations.MAKE_BIRTH);
