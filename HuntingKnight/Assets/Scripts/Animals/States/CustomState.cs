...
public class CustomState : State
{
    ...
    public CustomState(CommonAnimal commonAnimal, StateMachine stateMachine) : base(commonAnimal, stateMachine)
    {
    }
    ...
    {
        base.Enter();
        commonAnimal.animations.PlayAnimation(commonAnimal.animations.CUSTOM);
